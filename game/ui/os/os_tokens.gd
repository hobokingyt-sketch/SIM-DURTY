...
const EDGE_HIGHLIGHT: Color = Color("41484b")
const EDGE_MID: Color = Color("2b3134")
...
static func control_palette() -> Dictionary:
	return {
		...
		"well": WELL,
		"disabled": DISABLED,
		"control_housing": Color("121517"),
		"control_face": Color("24292c"),
		"control_face_hover": Color("2b3134"),
		"control_face_pressed": Color("1a1e20"),
		"disabled_face": Color("191c1e"),
		"selected_face": Color("25231e"),
		"selected_face_hover": Color("2d2921"),
		"primary_face": Color("332b20"),
		"primary_face_hover": Color("3b3123"),
		"primary_face_pressed": Color("241f19"),
		"handle_face": Color("181c1e"),
		"handle_face_hover": Color("22272a"),
		"fold_face": Color("15191b"),
		"fold_face_hover": Color("202529"),
	}
