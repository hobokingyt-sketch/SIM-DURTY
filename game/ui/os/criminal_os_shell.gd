...
func _build_right_record_views() -> void:
	...
	var activity_header: HBoxContainer = _app_header(activity_stack, "Session Record")
	var activity_back: Button = OsTokens.button(activity_header, "Back", func() -> void: _model.back())
	right_back_buttons.append(activity_back)
	OsTokens.button(activity_header, "City", func() -> void: _model.return_to_city())
	record_activity_tab = OsTokens.button(activity_header, "Activity", func() -> void: _model.navigate_view("activity"))
	record_storage_tab = OsTokens.button(activity_header, "Storage", func() -> void: _model.navigate_view("storage"))
	...
	var storage_header: HBoxContainer = _app_header(storage_stack, "Session Record")
	var storage_back: Button = OsTokens.button(storage_header, "Back", func() -> void: _model.back())
	right_back_buttons.append(storage_back)
	OsTokens.button(storage_header, "City", func() -> void: _model.return_to_city())
	OsTokens.button(storage_header, "Activity", func() -> void: _model.navigate_view("activity"))
	OsTokens.button(storage_header, "Storage", func() -> void: _model.navigate_view("storage"))
