...
func _build_right_record_views() -> void:
	...
	OsControls.apply(activity_back, OsControls.ROLE_NAV, OsTokens.control_palette(), 28)
	...
	OsControls.apply(activity_city, OsControls.ROLE_NAV, OsTokens.control_palette(), 28)
	...
	OsControls.apply(record_activity_tab, OsControls.ROLE_TAB, OsTokens.control_palette(), 28)
	...
	OsControls.apply(record_storage_tab, OsControls.ROLE_TAB, OsTokens.control_palette(), 28)
	...
	OsControls.apply(storage_back, OsControls.ROLE_NAV, OsTokens.control_palette(), 28)
	...
	OsControls.apply(storage_city, OsControls.ROLE_NAV, OsTokens.control_palette(), 28)
	...
	OsControls.apply(record_storage_activity_button, OsControls.ROLE_TAB, OsTokens.control_palette(), 28)
	...
	OsControls.apply(record_storage_storage_button, OsControls.ROLE_TAB, OsTokens.control_palette(), 28)
